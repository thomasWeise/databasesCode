...
"$postgres" "$exampleDir/generated_sql" 04_public_parent_table_5077.sql fixed
"$postgres" "$exampleDir/generated_sql" 05_public_student_parent_mobile_fk_constraint_5081.sql fixed
