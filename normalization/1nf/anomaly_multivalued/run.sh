...
"$postgres" "$exampleDir/generated_sql" 04_public_student_table_5079.sql anomalies
"$postgres" "$exampleDir/generated_sql" 05_public_student_student_address_1_fk_constraint_5085.sql anomalies
"$postgres" "$exampleDir/generated_sql" 06_public_student_student_address_2_fk_constraint_5086.sql anomalies
