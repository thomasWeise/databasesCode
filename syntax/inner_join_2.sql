-- The Syntax of an Two INNER JOINs.
-- We combine the information of tables Table_1, Table_2, Table_3.

-- Output rows are only created if rows in all three tables match.
