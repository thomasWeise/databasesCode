...
SELECT flight_number, start_date, start_time, start_airport, duration, dest_airport, tail_number, airplane_type.name AS type_name, speed,
 pilot.name AS pilot, flight_hours, qualification, pilot.date_of_birth AS pilot_dob, passenger.name AS passenger, passenger.date_of_birth AS passenger_dob, address, class, price
FROM booking
